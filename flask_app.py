...
cities = {
    ...
    'иннополис': ['1533899/a56d74f324c08006a65b'],
    'владивосток': ['213044/acb2b9d4632da71788d2']
}
    ...
    if attempt == 1:
        ...
        if get_city(req) == city:
            ...
            if attempt > len(cities[city]):
                # если попытка последняя, то значит, что все картинки мы показали.
